...
class TestInputBasedBezier:
    ...
    def test_conv_architecture(self):
        ...
        assert out_bezier.shape == expected_shape, f"Expected {expected_shape}, got {out_bezier.shape}"
...
class TestPillarBased:
    ...
    def test_pillar_architecture(self):
        ...
        assert output_tensor.shape == (2, 16, 128), f"Pillar output shape wrong: {output_tensor.shape}"
    ...
    def test_four_pillars_architecture(self):
        ...
        assert concatenated.shape == expected_cat_shape, f"Expected {expected_cat_shape}, got {concatenated.shape}"
    ...
    def test_four_pillars_parameter_count(self):
        ...
        params_total = (sum(p.numel() for p in p0.parameters()) +
...
class TestParameterComparisons:
    ...
    def test_two_layer_relu_baseline(self):
        ...
        params_total = (sum(p.numel() for p in layer1.parameters()) +
    ...
    def test_trainable_vs_relu(self):
        ...
        tb_total_params = (sum(p.numel() for p in linear2.parameters()) +
                          sum(p.numel() for p in tb.parameters()))

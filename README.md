...
- **Implementation:** 4 depth-3 MLPs generate context-dependent control points
- **Parameters:** 4×(depth=3)×D² (substantial overhead for expressiveness)
- **Usage:** Flow transformer MLP layers
- **Pattern:** `4×pillarLayer() → BezierActivation() → outputs`
